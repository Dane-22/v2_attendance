...
exports.decodeQRCodeData = decodeQRCodeData;
exports.verifyQRCodeData = verifyQRCodeData;
exports.extractEmployeeCode = extractEmployeeCode;
const crypto_1 = __importDefault(require("crypto"));
const QR_PREFIX = process.env.QR_PREFIX || 'JAJR-EMP';
function generateQRCodeData(employeeCode, version = 'V2') {
    if (version === 'V1') {
...
function verifyQRCodeData(qrData, maxAgeMinutes = 5) {
    try {
