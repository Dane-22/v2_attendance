...
export declare const calculateWeeklyPayrollBatch: (req: AuthenticatedRequest, res: Response, next: NextFunction) => Promise<void>;
export declare const approvePayrollOvertime: (req: AuthenticatedRequest, res: Response, next: NextFunction) => Promise<void>;
