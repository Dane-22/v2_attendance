...
export declare const markIndividualAbsent: (req: AuthenticatedRequest, res: Response, next: NextFunction) => Promise<void>;
export declare const markAbsent: (req: AuthenticatedRequest, res: Response, next: NextFunction) => Promise<void>;
