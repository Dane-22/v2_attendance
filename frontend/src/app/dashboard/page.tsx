    ...
    <div className="space-y-8 w-full">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          ...
          <p className={`${classes.textMuted} mt-1`}>Welcome back! Here&apos;s what&apos;s happening today.</p>
        </div>
        <Link
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
        <div className={`${classes.bgCard} rounded-xl ${classes.border} p-6 ${classes.borderHover} transition-colors`}>
          <div className="flex items-center justify-between">
            <div>
              <p className={`${classes.textMuted} text-sm uppercase tracking-wider`}>Total Employees</p>
          ...
          <div className="mt-4 flex items-center gap-2 text-sm">
            ...
            <span className={`${classes.textMuted}`}>workforce</span>
          </div>
        </div>
        ...
        <div className={`${classes.bgCard} rounded-xl ${classes.border} p-6 ${classes.borderHover} transition-colors`}>
          <div className="flex items-center justify-between">
            <div>
              <p className={`${classes.textMuted} text-sm uppercase tracking-wider`}>Today&apos;s Attendance</p>
          ...
          <div className="mt-4 flex items-center gap-2 text-sm">
            <CalendarCheck className={`w-4 h-4 ${classes.textMuted}`} />
            <span className={`${classes.textMuted}`}>Records today</span>
          </div>
        </div>
        ...
        <div className={`${classes.bgCard} rounded-xl ${classes.border} p-6 ${classes.borderHover} transition-colors`}>
          <div className="flex items-center justify-between">
            <div>
              <p className={`${classes.textMuted} text-sm uppercase tracking-wider`}>Present Rate</p>
          ...
          <div className="mt-4 flex items-center gap-2 text-sm">
            <span className={`${classes.textMuted}`}>Based on today&apos;s data</span>
          </div>
        </div>
        ...
        <div className={`${classes.bgCard} rounded-xl ${classes.border} p-6 ${classes.borderHover} transition-colors`}>
          <div className="flex items-center justify-between">
            <div>
              <p className={`${classes.textMuted} text-sm uppercase tracking-wider`}>Pending Payroll</p>
          ...
          <div className="mt-4 flex items-center gap-2 text-sm">
            <span className={`${classes.textMuted}`}>Processing next cycle</span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Quick Actions */}
        <div className={`lg:col-span-2 ${classes.bgCard} rounded-xl ${classes.border} p-6`}>
          <h2 className={`text-lg font-semibold ${classes.text} mb-6 flex items-center gap-2`}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            >
              ...
              <span className={`${classes.text} font-medium`}>Manage Employees</span>
              <span className={`${classes.textMuted} text-sm mt-1`}>View and edit staff</span>
              <ArrowRight className={`w-4 h-4 ${classes.textMuted} mt-3 group-hover:text-[#facc15] transition-colors`} />
            </Link>
            ...
            >
              ...
              <span className={`${classes.text} font-medium`}>Attendance</span>
              <span className={`${classes.textMuted} text-sm mt-1`}>Mark & view records</span>
              <ArrowRight className={`w-4 h-4 ${classes.textMuted} mt-3 group-hover:text-green-400 transition-colors`} />
            </Link>
            ...
            >
              ...
              <span className={`${classes.text} font-medium`}>Payroll</span>
        ...
        <div className={`${classes.bgCard} rounded-xl ${classes.border} p-6`}>
          <h2 className={`text-lg font-semibold ${classes.text} mb-4`}>Recent Activity</h2>
          <div className="space-y-4">
            <div className={`flex items-start gap-3 p-3 ${classes.bgCardHover} rounded-lg`}>
              ...
              <div>
                <p className={`${classes.text} text-sm`}>Attendance marked</p>
                <p className={`${classes.textMuted} text-xs mt-0.5`}>2 minutes ago</p>
              </div>
            </div>
            <div className={`flex items-start gap-3 p-3 ${classes.bgCardHover} rounded-lg`}>
              ...
              <div>
                <p className={`${classes.text} text-sm`}>New employee added</p>
                <p className={`${classes.textMuted} text-xs mt-0.5`}>1 hour ago</p>
              </div>
            </div>
            <div className={`flex items-start gap-3 p-3 ${classes.bgCardHover} rounded-lg`}>
              ...
              <div>
                <p className={`${classes.text} text-sm`}>QR scan completed</p>
                <p className={`${classes.textMuted} text-xs mt-0.5`}>3 hours ago</p>
              </div>
            </div>
          </div>
        </div>
