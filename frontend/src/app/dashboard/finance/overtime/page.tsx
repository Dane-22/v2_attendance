    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-gray-400">Placeholder page. Overtime module coming soon.</p>
        </div>
      </div>

      <div className="bg-[#141414] rounded-xl border border-[#262626] p-6">
        <p className="text-sm text-gray-300">
          This section will contain overtime approvals, totals, and exportable reports.
        </p>
      </div>
    </div>
  );
